...
- Guided room mapping that works without AR hardware; optional ARCore availability detection for future assisted placement.
...
4. Install `app-debug.apk` on an Android phone. Allow phone/location access if you want detailed radio readings, then test on both Jio and Airtel SIM routes.
